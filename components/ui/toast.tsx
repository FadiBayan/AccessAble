  ...
  return (
    <useToast.Root
      ...
      className={cn(
        ...
        variant === "success" && "success group border-green-500 bg-green-500 text-white",
        variant === "info" && "info group border-blue-500 bg-blue-500 text-white",
        variant === "warning" && "warning group border-orange-500 bg-orange-500 text-white",
        className,
      )}
      {...props}
    >
