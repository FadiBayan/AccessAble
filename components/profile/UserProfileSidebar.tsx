    ...
    <>
      ...
      <CardHeader className="relative p-0">
        ...
        <div 
          ...
          tabIndex={0} 
          aria-label={isEditing ? 'Change profile photo' : `View ${name}'s profile picture`} 
          role="button"
        >
          <Avatar className="w-24 h-24 rounded-full ring-2 ring-mustard border-4 border-white shadow-md bg-white hover:ring-4 transition-all">
